...
const companies = [
  { name: 'TCS', note: 'Tata Consultancy Services', logo: 'https://cdn.simpleicons.org/tcs/1f3a68' },
  { name: 'Cognizant', note: 'Cognizant', logo: '../public/cognizant.svg' },
  { name: 'Amdocs', note: 'Amdocs', logo: '../public/amdocs.svg' },
  { name: 'Amazon', note: 'Amazon', logo: '../public/aws.svg' },
  // /Users/ashif/MyWork/Nodejs/Portfolio-website/public/Aws--Streamline-Svg-Logos.svg
  { name: 'EY', note: 'Ernst & Young', logo: '../public/ey.svg' },
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
                ...
                <div className="p-4 pt-5 text-left">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <h3 className="font-display text-xl font-bold text-ink-50">Ashif Eqbal</h3>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-6 space-y-5 text-md leading-relaxed text-ink-700">
              <p>
                My name is Ashif Eqbal, and I am a passionate Senior DevOps Engineer 
                with experience in building scalable cloud architecture, designing and automating infrastructure management and orchestrating microservices using Kubernetes and ArgoCD. 
                
              </p>
              <p>
                I live in Jamshedpur, India and 
                currently working in EY as a Associate Architecture.
              
              
                Outside the terminal, I’m an avid movie watcher, especially Marvel films 
                (huge fan of Tobey Maguire's Spider-Man) and always on the hunt to explore new cuisines."
              </p>
            </div>
